...
cfg = {
	...
	damageFactorEngine = 1.99,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	damageFactorBody = 1.99,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	...
	weaponsDamageMultiplier = 0.02,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
	...
	engineSafeGuard = 100,					-- Final failure value. Set it too high, and the vehicle won't smoke when disabled. Set too low, and the car will catch fire from a single bullet to the engine. At health 100 a typical car can take 3-4 bullets to the engine before catching fire.
...
cfg = {
	...
	damageFactorEngine = 7.1,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
...
repairCfg = {
	...
	fixMessages = {
		"Has puesto el tapon del aceite en su sitio",
		"Has detenido la fuga de aceite con un chicle",
		"Has conseguido tapar la fuga del radiador con cinta aislante",
		"Pateaste el motor y mágicamente volvió a la vida",
		"Has recolocado el borne de la bateria"
	},
	fixMessageCount = 5,

	noFixMessages = {
	"Echaste un ojo al motor, pero parece todo correcto",
		"Parece que el motor sigue en su sitio",
		"Subiste el volumen de la radio. Simplemente ahogó los ruidos extraños del motor",
		"Nunca intentes arregler algo que no está roto"
	},
	noFixMessageCount = 4
}
