...
local atms = {
	...
	{name = "ATM", id = 277, x = -1390.86, y = -590.62, z = 29.32},
	{name = "ATM", id = 277, x = -821.35, y = -1082.3, z = 10.13},
	{name = "ATM", id = 277, x = 194.8, y = -3156.8, z = 4.79},
	{name = "ATM", id = 277, x = 758.88, y = -737.94, z = 26.62}
}
		...
		function()
			while true do
				...
				if nearBank() or isNearATM then
					ESX.ShowHelpNotification("Presiona ~y~E~s~ para acceder a la cuenta ~b~")
