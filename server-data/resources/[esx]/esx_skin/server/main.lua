...
AddEventHandler('esx_skin:save', function(skin)
	...
	local backpackModifier = Config.BackpackWeight[skin.bags_1]
		...
		if backpackModifier then
			...
			if xPlayer.getWeight() > defaultMaxWeight then
				xPlayer.showNotification('No puedes quitarte la mochila, �Esta llena!')
				TriggerClientEvent('esx_eden_clotheshop:forceResetSkin', source)
				return
			else
