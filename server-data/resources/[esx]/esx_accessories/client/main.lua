...
function QuitarCosasMenu()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'set_unset_accessory', {
		title = ('Apariencia'),
		align = 'bottom-right',
		elements = {
			{label = ('Manejar accesorios'), value = 'Accesorios'},
			{label = ('Manejar vestimenta'), value = 'Vestimenta'},
		}}, function(data, menu)
		menu.close()
		if data.current.value == 'Accesorios' then
			OpenAccessoryMenu()
		elseif data.current.value == 'Vestimenta' then
			TriggerEvent('esx_yisus_quitarropa:menuropa')
		end
