...
RegisterServerEvent('esx_eden_clotheshop:returnMoney')
AddEventHandler('esx_eden_clotheshop:returnMoney', function()
	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.addMoney(Config.Price)

	TriggerClientEvent('esx:showNotification', source, 'Se te ha devuelto el dinero')
end)
