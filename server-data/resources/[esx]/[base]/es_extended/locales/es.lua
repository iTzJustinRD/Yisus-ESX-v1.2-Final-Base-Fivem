Locales['es'] = {
    ...
    ['received_weapon_noweapon'] = '~b~%s~s~ intento darle munición para ~y~%s~s~, pero no tienes uno',
    ...
    ['ex_inv_lim'] = 'acción imposible, excediendo el límite de inventario para ~y~%s~s~',
    ...
    ['received_salary2'] = 'recibiste tu segundo salario: ~g~$%s~s~',
    ...
    ['received_paycheck'] = 'sueldo',
    ['received_paycheck2'] = 'segundo sueldo',
    ['bank'] = 'Banco Maze',
    ['account_bank'] = 'banco',
    ...
    -- Commands
    ['command_car'] = 'spawnear un vehiculo',
    ['command_car_car'] = 'nombre del vehiculo o hash',
    ['command_cardel'] = 'eliminar vehículo/s por proximidad',
    ...
    ['command_setgroup'] = 'establecer grupo a un jugador',
    ...
    ['tint_army'] = 'skin del ejercito',
    ['tint_lspd'] = 'skin azul',
    ['tint_orange'] = 'skin naranja',
    ['tint_platinum'] = 'skin de platino',

    --Misc
    ['afk_warning'] = 'Muevete, vas a ser expulsado por AFK.'
  }